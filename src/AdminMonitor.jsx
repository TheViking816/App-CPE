      ...
      {loading ? (
        ...
        <>
          ...
          <article className="monitor-card monitor-sync-card">
            ...
            <p className="monitor-sync-help">La actualización normal renueva el mes actual. La carga inicial completa recupera todo el año de jornales y primas y guarda las nóminas del año actual. Después puedes ejecutar la cola en el PC directamente desde este monitor.</p>

...
$shortcut.Arguments = '-NoProfile -ExecutionPolicy Bypass -NoExit -File "' + $runnerScript + '" -RepositoryPath "' + $RepositoryPath + '" -GatewayPort ' + $GatewayPort + ' -BatchSize 12 -WarmupSeconds 20'

drop function if exists public.app_cpe_create_admin_portal_sync_jobs(text);
...
begin
  ...
  v_slot_time := case
    ...
    when v_hour = 12 and v_minute between 15 and 29 then '12:15'
    when v_hour = 13 and v_minute between 30 and 44 then '13:30'

...
begin
  ...
  v_new_job := private.app_cpe_queue_portal_sync_job(
    p_chapa, v_password, v_security_key, 'worker_retry_5m',
  ...
  set requested_at = now() + interval '5 minutes',
      message = 'Reintento automático programado para dentro de 5 minutos',

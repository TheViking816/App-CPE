...
revoke all on function public.app_cpe_create_worker_manual_jobs() from public, anon, authenticated;
grant execute on function public.app_cpe_create_worker_manual_jobs() to service_role;

-- Requested doubles are a rolling seven-day window. A shorter recognized
-- result is authoritative: older dates naturally fall out of the window and
-- must not prevent newly requested dates from replacing the cached rows.

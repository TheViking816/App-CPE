-- Keep the selective-sync monitor aligned with the complete sync job table.
-- A later inactivity migration accidentally restored the old query that
-- excluded the administrator and ignored orphaned/legacy job rows.
